...
show_help() {
    ...
    echo ""
    echo "      Uses the ASP.NET Core Build System (KoreBuild) to build this repository."
    echo "      If not already present in the '.build' directory, this script downloads the latest copy"
    echo "      of the KoreBuild tools from https://github.com/aspnet/KoreBuild (or the URL/Branch provided in the arguments)."
    echo ""
    echo "Arguments:"
    ...
    echo "      --                                  Consider all remaining arguments arguments to KoreBuild when building the repo."
    echo ""
    echo "Notes:"
